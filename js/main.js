    ...
    function handleShowPopupLogin() {
      ...
      if (loginContainers) {
            loginContainers.forEach((loginContainer) => { 
                const showPopupLogins = loginContainer.querySelectorAll(".js__showPopupLogin");
                const popupLoginContainer = loginContainer.querySelector(".js__popupLoginContainer");

                if (popupLoginContainer && showPopupLogins.length > 0) {
                    ...
                    // Mở popup khi click vào các nút đăng nhập
                    ...
                    if (closePopupLogin) closePopupLogin.onclick = closeAll;
